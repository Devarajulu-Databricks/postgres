...
INSER-- Remove foreign key constraint from DEPARTMENTS table
ALTER TABLE departments DROP CONSTRAINT dept_mgr_fk;
...
INSERT INTO employees (employee_id, first_name, last_name, email, phone_number, hire_date, job_id, salary, commission_pct, manager_id, department_id) VALUES
    ...
    (134, 'Michael', 'Rogers', 'MROGERS', '650.127.2934', TO_DATE('27-JAN-1999', 'dd-MON-yyyy'), 'ST_CLERK', 2700, NULL, 122, 50),
    (135, 'Ki', 'Gee', 'KGEE', '650.127.3934', TO_DATE('17-JUN-1998', 'dd-MON-yyyy'), 'ST_CLERK', 2500, NULL, 122, 50),
    (136, 'Harrison', 'Bates', 'HBATES', '650.127.4934', TO_DATE('19-JUL-1999', 'dd-MON-yyyy'), 'ST_CLERK', 2300, NULL, 122, 50),
    (137, 'Ellen', 'Abel', 'EABEL', '650.127.5934', TO_DATE('03-FEB-2000', 'dd-MON-yyyy'), 'ST_CLERK', 2600, NULL, 122, 50),
    ...
    (168, 'Lisa', 'Ozer', 'LOZER', '011.44.1343.929268', TO_DATE('11-MAR-1997', 'DD-MON-YYYY'), 'SA_REP', 8500, 0.25, 148, 80),
    (169, 'William', 'Smith', 'WSMITH', '011.44.1343.829268', TO_DATE('10-JUN-1997', 'DD-MON-YYYY'), 'SA_REP', 7800, 0.2, 148, 80),
    (170, 'Randy', 'Moon', 'RMOON', '011.44.1343.729268', TO_DATE('09-NOV-1997', 'DD-MON-YYYY'), 'SA_REP', 7300, 0.2, 148, 80),
    (171, 'Nancy', 'Cabrera', 'NCABRERA', '011.44.1343.529268', TO_DATE('14-AUG-1998', 'DD-MON-YYYY'), 'SA_REP', 7200, 0.2, 148, 80),
    (172, 'Nancy', 'Green', 'NGREEN', '011.44.1343.429268', TO_DATE('19-MAY-1999', 'DD-MON-YYYY'), 'SA_REP', 6800, 0.15, 148, 80),
    (173, 'John', 'Smith', 'JSMITH', '011.44.1343.329268', TO_DATE('25-MAR-2000', 'DD-MON-YYYY'), 'SA_REP', 6500, 0.1, 148, 80),
    (174, 'Ellen', 'Abel', 'DEVA', '011.44.1644.429267', TO_DATE('11-MAY-1996', 'DD-MON-YYYY'), 'SA_REP', 11000, 0.30, 149, 80),
    (175, 'Alyssa', 'Hutton', 'AHUTTON', '011.44.1644.429266', TO_DATE('19-MAR-1997', 'DD-MON-YYYY'), 'SA_REP', 8800, 0.25, 149, 80),
    (176, 'Jonathon', 'Taylor', 'JTAYLOR', '011.44.1644.429265', TO_DATE('24-MAR-1998', 'DD-MON-YYYY'), 'SA_REP', 8600, 0.20, 149, 80),
    (177, 'Jack', 'Livingston', 'JLIVINGS', '011.44.1644.429264', TO_DATE('23-APR-1998', 'DD-MON-YYYY'), 'SA_REP', 8400, 0.20, 149, 80),
    (178, 'Kimberely', 'Grant', 'KGRANT', '011.44.1644.429263', TO_DATE('24-MAY-1999', 'DD-MON-YYYY'), 'SA_REP', 7000, 0.15, 149, NULL),
    (179, 'Charles', 'Johnson', 'CJOHNSON', '011.44.1644.429262', TO_DATE('04-JAN-2000', 'DD-MON-YYYY'), 'SA_REP', 6200, 0.10, 149, 80),
...
RETURNS void AS $$
BEGIN
    -- Check if the current time is within office hours (08:00 - 18:00) and is not on a weekend
    IF EXTRACT(HOUR FROM CURRENT_TIME) NOT BETWEEN 8 AND 17
    OR TO_CHAR(CURRENT_DATE, 'Day') IN ('Saturday', 'Sunday') THEN
        RAISE EXCEPTION 'You may only make changes during normal office hours';
    END IF;
END;
$$ LANGUAGE plpgsql;
 
/* -- Below part from oracle 
